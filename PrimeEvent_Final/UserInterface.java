...
public class UserInterface
{
    ...
    public void diplayAHallDetail(Hall hall)
    {
        ...
        System.out.println("3. hall Base Price: $" + df.format(hall.getHallBasePrice()) + " per person");
        System.out.println("4. hall Hall Capacity: " + hall.getHallCapacity());
        System.out.println("5. hall size: " + hall.getHallSize() + " square meter");
        System.out.println("6. hall Average Rating: " + df.format(hall.getAverageRating()) );
        System.out.println("7. hall description" + hall.getHallDesc());
        System.out.println("8. Available date and time");
    ...
    /**
     * method to display timeslot menu
     */
