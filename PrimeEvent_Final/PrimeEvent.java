...
public class PrimeEvent
{
    ...
    public void setQuotation(Hall hall)
    {
        ...
        while(bool)
        {
            ...
            switch(choic)
            {
                ...
                case "N":logedInUser.addQuotation(quotation);enterCustomerMenu();break;
                default: boundary.displayInvalidInput();bool = true;
            }
        }
    ...
    public void askForTheDateAndTime(Quotation quot)
    {
        ...
        while (bool)
        {
            ...
            {
                System.out.println("Please input as date format!");
                bool = true;
            }
    ...
    public void writeReview(Booking bk)
    {
        ...
        do
        {
            System.out.println("please input the rating number(1 to 5): ");
            try
            {
        ...
        do
        {
            System.out.println("please input the comment(within 2000 characters): ");
            try
            {
