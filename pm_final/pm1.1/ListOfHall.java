...
public class ListOfHall
{
    ...
    public ListOfHall()
    {
        ...
        Hall h1= new Hall("Hawker Hall","Just beers on tap that we believe in.Beers that are fresh and, most importantly, brewed to be enjoyed with our hawker food","98 CHAPEL STREET",40.0f, 78.4f, 27,  datetimesNotAvailable1);
        halls.add(h1);
        halls.add(new Hall("StKilda Hall","St Kilda Town Hall is a grand, classically styled city hall","99A Carlisle St",35.0f, 67.2f, 35,  datetimesNotAvailable2));//comment
    }
